 ...
 * based on double hashing (dh). It realizes the main foundations of the
 * technique "Hash (dh)" from:
 *
 *   ==========================================================================
...
using namespace cds_static;
	...
	class Hashdh: public Hash{
		...
		public:
			...
			/* Retrieves the i-th position in the hash table. It returns the same value that
			 * "getValue" for HashB and HashBB.
