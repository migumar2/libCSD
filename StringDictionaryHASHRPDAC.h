...
#ifndef _STRINGDICTIONARY_HASHRPDAC_H
#define _STRINGDICTIONARY_HASHRPDAC_H
...
class StringDictionaryHASHRPDAC : public StringDictionary
{
	public:
		...
		*/
		StringDictionaryHASHRPDAC(IteratorDictString *it, uint len, int overhead);
