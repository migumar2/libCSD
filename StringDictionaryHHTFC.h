 ...
 * (string headers) and canonical Huffman code [2] (internal strings).
 * 
 *   ==========================================================================
 ...
 *     Addison Wesley, 1973.
 *
 *     [2] "Generating a Canonical Prefix Encoding"
 *     E. S. Schwartz and B. Kallick
 *     Communications of the ACM, 7:166–169, 1964.
 *   ==========================================================================
 *
 ...
 * extract operations ** by prefix **, and performs Huffman encoding on the
...
#ifndef _STRINGDICTIONARY_HHTFC_H
#define _STRINGDICTIONARY_HHTFC_H
...
class StringDictionaryHHTFC : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryHHTFC();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		    @param bucketsize: number of strings represented per bucket.
		*/
		StringDictionaryHHTFC(IteratorDictString *it, uint bucketsize);
	...
	protected:
		...
		StatCoder *coderHU;	//! Coder for Huffman operations
		Codeword *codewordsHU;	//! Huffman codeword assignment
...
#endif  /* _STRINGDICTIONARY_HHTFC_H */
